...
#SBATCH --gpus=a100:1
#SBATCH --time=015:10:00
#SBATCH --output=/blue/ruogu.fang/jbroce/GatorBrain/code/logs/%x.%j.out
...
singularity exec --nv --bind /red /blue/ruogu.fang/jbroce/monaicore0.9.1 python3 ./run_models.py 'config.ini'
