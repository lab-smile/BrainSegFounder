#!/bin/bash
#SBATCH --job-name=Jan8_FinetuningSWINUNETR_M4channels_1Stage_UKB40k_BTRATS-_MultipleGPUs_Fold1_
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --gpus=2
...
batch_size=2
optim_lr=1e-4
logdir='Jan8_FinetuningSWINUNETR_M4channels_1Stage_UKB40k_MultipleGPUs_BTRATS_Fold1_'
