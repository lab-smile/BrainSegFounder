#!/bin/bash
#SBATCH --job-name=Jan5_FinetuningSWINUNETR_Tiny4channels_2Stage_UKB40k_BTRATS-_MultipleGPUs_Fold0_LR1e3_
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --gpus=2
...
batch_size=2
optim_lr=1e-3
logdir='Jan5_FinetuningSWINUNETR_Tiny4channels_2Stage_UKB40k_MultipleGPUs_BTRATS_Fold0_LR1e3_'
