#!/bin/bash
#SBATCH --job-name=Jan11_FinetuningSWINUNETR_Tiny4channels_2Stage_UKB40k_BTRATS-_MultipleGPUs_Fold0_LR2e4_
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --gpus=2
...
batch_size=2
optim_lr=2e-4
logdir='Jan11_FinetuningSWINUNETR_Tiny4channels_2Stage_UKB40k_MultipleGPUs_BTRATS_Fold0_LR2e4_'
