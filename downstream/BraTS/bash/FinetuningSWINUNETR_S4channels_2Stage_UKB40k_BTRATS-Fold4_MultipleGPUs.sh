#!/bin/bash
#SBATCH --job-name=Dec20_FinetuningSWINUNETR_S4channels_2Stage_UKB40k_BTRATS-_MultipleGPUs_Fold4_
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --gpus=2
...
fold=4
#pretrained model
path_to_pretrained_dir="/blue/ruogu.fang/pliu1/SwinUNETR_pretrain_2channel/runs/run_Stage2Pretrain_TargetBRATS_SmallT1T2_Fold4_GPU002_D18_H3_12-14-2023-09:43:10/"
...
batch_size=2
optim_lr=1e-4
logdir='Dec20_FinetuningSWINUNETR_S4channels_2Stage_UKB40k_MultipleGPUs_BTRATS_Fold4_'
