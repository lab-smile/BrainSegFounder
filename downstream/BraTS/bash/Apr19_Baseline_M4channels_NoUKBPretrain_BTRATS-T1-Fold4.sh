#!/bin/bash
#SBATCH --job-name=Apr20_Baseline_M4channels_NoUKBPretrain_BTRATS_T1_Fold4_
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --gpus=1
...
batch_size=1
optim_lr=1e-4
logdir='Apr20_Baseline_M4channels_NoUKBPretrain_BTRATS_T1_4copy_Fold4_'
#add timestamp to logdir
disturl="tcp://127.0.0.1:23427"
ls
...
--optim_lr=$optim_lr --save_checkpoint --logdir=$logdir  --dist-url=$disturl