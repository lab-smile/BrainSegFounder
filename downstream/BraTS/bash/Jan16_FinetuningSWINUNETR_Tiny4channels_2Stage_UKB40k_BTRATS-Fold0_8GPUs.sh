#!/bin/bash
#SBATCH --job-name=Jan16_FinetuningSWINUNETR_Tiny4channels_2Stage_UKB40k_8GPUsBatchSize1LR1e4_BTRATS_Fold0_
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --gpus=8
...
batch_size=1
optim_lr=1e-4
logdir='Jan16_FinetuningSWINUNETR_Tiny4channels_2Stage_UKB40k_8GPUsBatchSize1LR1e4_BTRATS_Fold0_'
