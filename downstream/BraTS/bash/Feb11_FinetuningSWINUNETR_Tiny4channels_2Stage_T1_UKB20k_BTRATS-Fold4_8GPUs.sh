#!/bin/bash
#SBATCH --job-name=Feb11_FinetuningSWINUNETR_Tiny4channels_2Stage_T1_UKB20k_BTRATS_8GPUs_Fold4_
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --gpus=8
...
max_epochs=800
#pretrained model
path_to_pretrained_dir="/blue/ruogu.fang/pliu1/SwinUNETR_pretrain_2channel/runs/run_Feb72024_Stage2Pretrain_TargetBRATS_Size_Tini_T1_UKB20K_Fold4_GPU002_D6_H3_02-07-2024-09:06:44/"
...
batch_size=2
optim_lr=8e-4
logdir='Feb11_FinetuningSWINUNETR_Tiny4channels_2Stage_T1_UKB20k_BTRATS_8GPUs_Fold4_'
