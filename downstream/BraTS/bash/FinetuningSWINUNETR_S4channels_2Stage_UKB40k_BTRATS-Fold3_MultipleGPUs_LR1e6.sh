#!/bin/bash
#SBATCH --job-name=Jan7_FinetuningSWINUNETR_S4channels_2Stage_UKB40k_BTRATS-_MultipleGPUs_Fold3_LR1e6_
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --gpus=2
...
#training
batch_size=2
optim_lr=2e-6 #1e-6 for each GPU; if we use 2 GPUs, then the learning rate should be 2e-6
logdir='Jan7_FinetuningSWINUNETR_S4channels_2Stage_UKB40k_MultipleGPUs_BTRATS_Fold3_LR1e6_'
