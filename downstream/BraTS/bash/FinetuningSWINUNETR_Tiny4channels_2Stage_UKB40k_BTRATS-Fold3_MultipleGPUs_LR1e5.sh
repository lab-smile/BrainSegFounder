#!/bin/bash
#SBATCH --job-name=Jan7_FinetuningSWINUNETR_Tiny4channels_2Stage_UKB40k_BTRATS-_MultipleGPUs_Fold3_LR1e5_
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --gpus=2
...
fold=3
#pretrained model
path_to_pretrained_dir="/blue/ruogu.fang/pliu1/SwinUNETR_pretrain_2channel/runs/run_Dec30_Stage2Pretrain_TargetBRATS_SizeTini_T1T2_Fold3_GPU002_D6_H3_01-04-2024-14:21:03/"
...
#training
batch_size=2
optim_lr=2e-5 #1e-5 for each GPU; if we use 2 GPUs, then the learning rate should be 2e-5
logdir='Jan7_FinetuningSWINUNETR_Tiny4channels_2Stage_UKB40k_MultipleGPUs_BTRATS_Fold3_LR1e5_'
