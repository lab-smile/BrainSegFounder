#!/bin/bash
#SBATCH --job-name=Jan14_FinetuningSWINUNETR_M4channels_2Stage_UKB10k_BTRATS-_MultipleGPUs_Fold3_
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --gpus=2
...
fold=3
#pretrained model
path_to_pretrained_dir="/blue/ruogu.fang/pliu1/SwinUNETR_pretrain_2channel/runs/run_Jan8_Stage2Pretrain_TargetBRATS_Msize_T1T2_Fold3_UKB10k_GPU002_D2_H3_01-13-2024-15:57:27/"
...
batch_size=2
optim_lr=1e-4
logdir='Jan14_FinetuningSWINUNETR_M4channels_2Stage_UKB10k_MultipleGPUs_BTRATS_Fold3_'
