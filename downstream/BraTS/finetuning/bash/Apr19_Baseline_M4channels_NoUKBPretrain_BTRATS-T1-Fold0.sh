#!/bin/bash
#SBATCH --job-name=Apr20_Baseline_M4channels_NoUKBPretrain_BTRATS_T1_Fold0_
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --gpus=2
...
batch_size=2
optim_lr=1e-4
logdir='Apr20_Baseline_M4channels_NoUKBPretrain_BTRATS_T1_4copy_Fold0_'
#add timestamp to logdir
disturl="tcp://127.0.0.1:23417"
