#!/bin/bash
#SBATCH --job-name=Feb19_FinetuningSWINUNETR_Tiny4channels_2Stage_UKB40k_64GPUsBatchSize1LR1e3_BTRATS_Fold1_
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --gpus=64
...
batch_size=1
optim_lr=1e-3
logdir='Feb19_FinetuningSWINUNETR_Tiny4channels_2Stage_UKB40k_64GPUsBatchSize1LR1e3_BTRATS_Fold1_'
