#!/bin/bash
#SBATCH --job-name=Mar28_FinetuningSWINUNETR_Tiny4channels_2Stage_T1_UKB20k_BTRATS_2GPUs_Fold3_
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --gpus=2
...
max_epochs=800
#pretrained model
path_to_pretrained_dir="/blue/ruogu.fang/pliu1/SwinUNETR_pretrain_2channel/runs/run_Feb62024_Stage2Pretrain_TargetBRATS_Size_Tini_T2_UKB20K_Fold3__GPU002_D6_H3_03-27-2024-13:45:50/"
...
batch_size=2
optim_lr=8e-4
logdir='Mar28_FinetuningSWINUNETR_Tiny4channels_2Stage_T1_UKB20k_BTRATS_8GPUs_Fold3_'
