#!/bin/bash
#SBATCH --job-name=Jan8_FinetuningSWINUNETR_M4channels_2Stage_UKB20k_BTRATS-_MultipleGPUs_Fold3_
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --gpus=2
...
fold=3
#pretrained model
path_to_pretrained_dir="/blue/ruogu.fang/pliu1/SwinUNETR_pretrain_2channel/runs/run_Jan7_Stage2Pretrain_TargetBRATS_Msize_T1T2_Fold3_UKB20k_GPU002_D2_H3_01-07-2024-15:51:08/"
...
batch_size=2
optim_lr=1e-4
logdir='Jan8_FinetuningSWINUNETR_M4channels_2Stage_UKB20k_MultipleGPUs_BTRATS_Fold3_'
