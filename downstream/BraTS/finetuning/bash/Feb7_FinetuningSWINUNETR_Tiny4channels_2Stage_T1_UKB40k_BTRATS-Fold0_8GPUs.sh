#!/bin/bash
#SBATCH --job-name=Feb7_FinetuningSWINUNETR_Tiny4channels_2Stage_T1_UKB40k_BTRATS_8GPUs_Fold0_
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --gpus=8
...
max_epochs=800
#pretrained model
path_to_pretrained_dir="/blue/ruogu.fang/pliu1/SwinUNETR_pretrain_2channel/runs/run_Feb52024_Stage2Pretrain_TargetBRATS_SizeTini_T1_UKB40_Fold0_GPU002_D6_H3_02-05-2024-14:56:32/"
...
batch_size=8
optim_lr=8e-4
logdir='Feb7_FinetuningSWINUNETR_Tiny4channels_2Stage_T1_UKB40k_BTRATS_8GPUs_Fold0_'
