#!/bin/bash
#SBATCH --job-name=Jan15_FinetuningSWINUNETR_Tiny4channels_2Stage_UKB40k_BTRATS- 8GPUs_Fold4_
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --gpus=8
...
batch_size=8
optim_lr=8e-4
logdir='Jan15_FinetuningSWINUNETR_Tiny4channels_2Stage_UKB40k_8GPUs_BTRATS_Fold4_'
