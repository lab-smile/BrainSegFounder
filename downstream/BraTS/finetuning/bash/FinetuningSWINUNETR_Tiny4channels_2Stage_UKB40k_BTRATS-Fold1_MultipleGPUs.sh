#!/bin/bash
#SBATCH --job-name=Jan5_FinetuningSWINUNETR_Tiny4channels_2Stage_UKB40k_BTRATS-_MultipleGPUs_Fold1_
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --gpus=2
...
fold=1
#pretrained model
path_to_pretrained_dir="/blue/ruogu.fang/pliu1/SwinUNETR_pretrain_2channel/runs/run_Dec30_Stage2Pretrain_TargetBRATS_SizeTini_T1T2_Fold1_GPU002_D6_H3_01-04-2024-14:21:02/"
...
batch_size=2
optim_lr=1e-4
logdir='Jan5_FinetuningSWINUNETR_Tiny4channels_2Stage_UKB40k_MultipleGPUs_BTRATS_Fold1_'
