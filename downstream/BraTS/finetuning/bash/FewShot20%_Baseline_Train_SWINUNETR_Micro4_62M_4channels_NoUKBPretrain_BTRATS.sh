#!/bin/bash
#SBATCH --job-name=Mar26_Fewshot20_Baseline_Pretrain_SWINUNETR_62M_4channels_NoUKBPretrain_BTRATS_
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --gpus=2
...
#data
json_list_train="/blue/ruogu.fang/pliu1/BRATS21/jsons/brats21_fewshot_train_20%.json"
...
batch_size=2
optim_lr=1e-4
logdir='Mar26_Fewshot20_Baseline_Pretrain_SWINUNETR_62M_4channels_NoUKBPretrain_BTRATS_'
